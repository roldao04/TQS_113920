...
public class OpenAPIConfig {
    ...
    @Value("${BACKEND_API_URL:http://localhost:8080}")
    ...
    public OpenAPI myOpenAPI() {
        ...
        Info info = new Info()
                .title("Moliceiro Canteen API")
                .version("1.0")
                .contact(contact)
                .description("This API exposes endpoints for the Moliceiro Canteen Management System.")

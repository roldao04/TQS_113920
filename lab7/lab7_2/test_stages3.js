...
export const options = {
  ...
  // Define thresholds to assess test performance based on SLOs
  thresholds: {
    // Ensure that the 95th percentile (p(95)) of the request duration is lower than 1.1 seconds
    "http_req_duration": ["p(95)<1100"],

    // Ensure that the failure rate of HTTP requests is less than 1%
